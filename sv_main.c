...
cvar_t sv_sound_land = {0, "sv_sound_land", "player/land.wav", "sound to play when MOVETYPE_STEP entity hits the ground at high speed (empty cvar disables the sound)"};
